class Game {
  ...
  start() {
    ...
    this.spawnsprites(fuelGroup,6,fuelImage,0.02);
    this.spawnsprites(powerGroup,20,powerCoinImage,0.09)
  }

   spawnsprites(spritegroup,numbersprites,spriteImg,scale){
  ...
  handlepowercoin(index){
    cars[index-1].overlap(powerGroup,function(collector,collected){
     collected.remove();
     player.update();
